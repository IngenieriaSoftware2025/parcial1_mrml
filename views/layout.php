...
<head>
    ...
    <title>CARLOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOS</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="/parcial1_mrml">
                <img src="<?= asset('./images/icon.png') ?>" width="35px'" alt="cit" >
                HOLAMUNDO
            </a>
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/parcial1_mrml"><i class="bi bi-house-fill me-2"></i>Inicio</a>
                    </li>
  <!-- 1 -->
